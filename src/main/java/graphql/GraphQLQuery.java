 ...
 * GraphQL object.
 *
 * <p>Note: It is generic in T, which associates the query with an expected return type. This is not
 ...
 *
 * @param <T> Any class that will be produced from the GraphlQL query.
 */
